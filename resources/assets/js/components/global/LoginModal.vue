...
<template>
  <div id="login-modal" v-show="show" v-on:click="show = false">
    <div class="login-box" v-on:click.stop="">
      ...
      <p class="learn-more-description">We are developing an ever expanding network of used things, to some it's junk, to some it's just what they were looking for. Be part of the collective collection and scavange away!</p>
